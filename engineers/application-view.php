<?php
  ...
  $app=$db->row('select *,checker.name as checkername,u.name as fullname from m_applications as m inner join user as u on m.user=u.username left join user as checker on m.checked_by=checker.username where m.app_no=:appno',['appno'=>$_GET['id']]);
  $ispending=$app->status=='pending'?true:false;
  $isapproved=$app->status=='approved'?true:false;
  $pagename='Application by  '.$app->fullname;
?>
<!DOCTYPE html>
<html>
      ...
      <div class="row">
          ...
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                ...
                <?php
                  ...
                  {
                    ?>
                      <h6 class="heading-small text-muted mb-4">Checked By <span class="text-primary"><?php echo $app->checkername; ?></span></h6>
                    <?php
                  }
                ?>
                  ...
                  <div class="row justify-content-around">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" data-mask="____-___-_" name="building_permit_no" disabled value="<?php echo $app->building_permit_no ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                ...
                <?php addform('decline','cont/application',$app->app_no) ?>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="form-group col text-right">
                      <button class="btn btn-lg btn-sm btn-danger" type="button" onclick="document.getElementById('decline').submit();" <?php echo !$ispending?'disabled':''; ?>><i class="ni ni-check-bold"></i> Decline application</button>
                    </div>
        ...
        <div class="col-xl-12 order-xl-1 mt-4">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                <form action="<?php echo navigate('cont/application') ?>" method="post" id="approve">
