              ...
              <div class="row align-items-center">
                <div class="col-8">
                  ...
                  <div class="form-group col text-right">
                    <button class="btn btn-lg btn-sm btn-warning" type="button" onclick="window.location.href='<?php echo navigate('admin/applist') ?>'"><i class="ni ni-bold-left"></i> Back</button>
                  </div>
              </div>
            </div>
            <div class="card-body">
