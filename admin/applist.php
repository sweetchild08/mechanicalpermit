              ...
              <table class="table align-items-center table-dark table-flush">
                ...
                <tbody>
                  ...
                  if(isset($_GET['keyword']))
                  {
                    ...
                    $rows=$db->rows('select * from m_applications as m inner join user as u on m.user=u.username'.($where??''));
                    foreach($rows as $row)
                    {
                  ?>
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo navigate('admin/application-view?id='.$row->app_no); ?>'">View</button>
                          </td>
                        </tr>
                    <?php } ?>
